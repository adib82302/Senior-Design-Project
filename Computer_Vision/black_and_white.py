...
# Settings
video_path = '/Users/adibk/Downloads/20240209_130940A.mp4'
...
while cap.isOpened():
    ...
    for image in still_images:
        ...
        for box in boxes:
            ...
            cv2.rectangle(gray, (x1, y1), (x2, y2),(0,0,255), 5)
            
            # Confidence
            conf = math.ceil((box.conf[0]*100))/100
            cv2.putText(gray, f'{conf}', (x1, y1-20), cv2.FONT_HERSHEY_SIMPLEX, 1, text_color, 5)

    #Post-Processing
    cv2.imshow("Video Feed with Detection", gray)
